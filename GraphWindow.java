...
// The 3D graphics has to be installed separately.
// I am using 2D graphics to show how 3D graphics
// transformations and projections work.  To show
// the math.  But in real graphics 
// programming you'd be programming the GPU
// to do the math for you, with something like
// OpenGL or CUDA.

// So this isn't used here:
...
public class GraphWindow extends JFrame implements
                                WindowListener,
                                WindowFocusListener,
                                WindowStateListener,
                                ActionListener
  ...
  private GraphPanel mainPanel = null;
  ...
  public GraphWindow( MainApp useApp,
                               String showText )
    {
    super( showText );
